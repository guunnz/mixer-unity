...
namespace finished3
{
    public class EnemyTeam : MonoBehaviour
    {
        ...
        private Dictionary<CharacterInfo, MyTeam.CharacterState> characters =
            new Dictionary<CharacterInfo, MyTeam.CharacterState>();

        private PathFinder pathFinder;
        public MyTeam enemyTeam;
        ...
        private void RecalculatePath(CharacterInfo character, MyTeam.CharacterState state)
        {
        ...
        public void AddCharacter(CharacterInfo character, Vector2Int? gridLocation = null)
        {
            ...
            while (startingTile == null || startingTile.occupied)
            {
                ...
                {
                    gridLocation = new Vector2Int(Random.Range(4, 8), Random.Range(0, 5));
                }
            ...
            characters[character] = new MyTeam.CharacterState
            {
