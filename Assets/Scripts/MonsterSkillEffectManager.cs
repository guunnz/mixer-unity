...
public class PoisonMonsterPlayer
{
    public string monsterId;
    public int poisonTimes;
}

public class MonsterSkillEffectManager : MonoBehaviour
{
    ...
    public void AddStatusEffect(SkillEffect skillEffect, string monsterId = "")
    {
        ...
        if (statusEffect == StatusEffectEnum.Poison && !string.IsNullOrEmpty(monsterId))
        {
            AddPoisonTarget(skillEffect.PoisonStack, monsterId);
        }
    ...
    public void AddPoisonTarget(int times, string monsterId)
    {
        if (poisonPlayersList.Any(x => x.monsterId == monsterId))
        {
            var poisonPlayer = poisonPlayersList.Single(x => x.monsterId == monsterId);

            poisonPlayer.poisonTimes += times;
        }
        else
        {
            var poisonPlayer = new PoisonMonsterPlayer();
            poisonPlayer.monsterId = monsterId;
            poisonPlayer.poisonTimes = times;
